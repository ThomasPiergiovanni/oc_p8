...
urlpatterns = [
    ...
    path('product_detail/<int:id_prod>', ProductDetailView.as_view(), name='product_detail'),
    path('favorites/', FavoritesView.as_view(), name='favorites'),
    path('results/', ResultView.as_view(), name='results'),
    path('register_favorite/<int:id_prod>', RegisterFavoriteView.as_view(), name='register_favorite' ),
